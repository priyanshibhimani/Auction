...
//                if (lotsizes != null && lotsizes.Count > index)
//                {
//                    var lot = lotsizes[index].InnerHtml.Trim();
//                    Regex regex = new Regex(pattern2);
//                    Match match = regex.Match(lot);

//                    if (match.Success)
//                    {
//                        lotCount = match.Value;
//                    }
//                }
...
//                    ImageUrl = CleanString(imgUrls[index].GetAttributeValue("src", "")),
//                    Link = CleanString(links[index].GetAttributeValue("href", "")),
...
//            string cleanedInput = Regex.Replace(input.Trim(), @"\s+", " ");
//            return cleanedInput;
//        }
